...
public abstract class ContainerLockEnforcementMixin {
    ...
    private ItemStack inventoryMax$treatLockedContainerAsEmpty(Slot slot,
    ...
    private boolean inventoryMax$blockLockedContainerDestination(Slot slot, ItemStack stack,
